    ...
    <footer>
      <div className="container wrap">
        <div className="footer_info">
          <span>Digital Image Processing and Deep Learning <b>Research Group</b> | {new Date().getFullYear()}</span>
          <br/>
          <br/>
        ...
        <div className="footerLogos">
            ...
            <Link to="#"><img id = "nautec" src={nautecLogo} alt="Intelligent automation and robotics group" /></Link>
...
>>>>>>> ad23321f84eeb9be5e3751831a9470dacbafeb2e
}
