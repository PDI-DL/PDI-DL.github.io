        ...
        <div>
            ...
            <div className="news">
                <div className={`card ${hasMaxHeight ? 'cardExpand' : ''}`} id="1">
                    ...
                    <h3>37ª Conference on Graphics, Patterns and Images</h3>
                    <h3>Author<sup>1</sup>, Author<sup>2</sup>, Author<sup>3</sup>, Author<sup>4</sup>, Author<sup>5</sup>, Author<sup>6</sup>, Author<sup>7</sup>, Author<sup>8</sup></h3>
